...
const defaultMediaByTitle: Record<string, string> = {
  ...
  'puente de gluteo': '/puente-de-gluteo.gif',
  'sentadilla hack': '/sentadilla-hack.gif',
  'sentadilla con mancuerna': '/sentadilla-mancuerna.gif',
  'peso muerto': '/peso-muerto.gif',
  'peso muerto sumo': '/peso-muerto-sumo.gif',
  'peso muerto rumano': '/peso-muerto-rumano.gif',
  'hip thrust': '/hip-thrust.gif',
  'hack squat': '/hack-squat.gif',
  'bulgaras': '/bulgaras.gif',
  'extension de cuadriceps': '/extension-cuadriceps.gif',
  'curl femoral': '/curl-femoral.gif',
  'elevacion de talones': '/elevacion-talones.gif',
  'jalon al pecho': '/jalon-al-pecho.gif',
  'press militar': '/press-militar.gif',
  'remo': '/remo.gif',
  'sentadilla': '/sentadilla.gif',
  'pallof press': '/pallof-press.gif',
  'dominadas supinas': '/dominadas-supinas.gif',
  'dominadas neutras': '/dominadas-neutras.gif',
  'prensa inclinada': '/prensa-inclinada.gif',
  'plancha frontal': '/plancha-frontal.gif',
